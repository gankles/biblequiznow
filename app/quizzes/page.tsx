...
export const metadata: Metadata = {
  title: 'All Bible Quizzes - BibleQuizNow',
  description: 'Browse our complete collection of Bible quizzes covering all 66 books, characters, themes, and difficulty levels. Free interactive quizzes with instant scoring.',
  keywords: 'Bible quizzes, Scripture tests, biblical knowledge, Old Testament, New Testament, Bible study',
  openGraph: {
    title: 'All Bible Quizzes - BibleQuizNow',
    description: 'Browse our complete collection of Bible quizzes covering all 66 books, characters, themes, and difficulty levels.',
    url: '/quizzes',
  },
};
      ...
      <div className="max-w-7xl mx-auto container-padding py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Test your biblical knowledge with our comprehensive collection of quizzes. 
            Choose from different books, themes, and difficulty levels.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {QUIZ_CATEGORIES.map((category) => (
              <Link
                ...
                className="group bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md hover:border-primary-200 transition-all duration-200"
              >
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/quizzes/random" className="btn-outline">
              Random Quiz
            </Link>
          </div>
        ...
        <div className="bg-primary-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
            Choose a quiz above or let us surprise you with a random selection from our extensive collection.
          </p>
