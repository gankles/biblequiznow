    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <p className="text-gray-600 mt-1">
          Continue your biblical learning journey with these related quizzes
        </p>
      </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <h4 className="text-lg font-display font-semibold text-gray-900 group-hover:text-primary-600 transition-colors duration-200 line-clamp-2">
                    {quiz.title}
                  </h4>
                </div>
              </div>
